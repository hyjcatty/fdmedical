...
$(function(){
    var pieData = [
                    {label:'烧伤',data: 1, color: 'rgba(255,255,255,0.4)'},
                    {label:'破片',data: 2, color: 'rgba(255,255,255,0.8)'},
                    {label:'枪伤',data: 3, color: 'rgba(255,255,255,0.6)'},
                    {label:'中毒',data: 4, color: 'rgba(255,255,255,0.2)'},
                    {label:'心理疾病',data: 5, color: 'rgba(255,255,255,0.9)'},
                ];
    if($('#donut-chart')[0]){
